                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('signin') }}">
                        ...
                        <div class="form-group mb-3">
                            <input type="text" placeholder="Email" id="email" class="form-control p-2" name="email"
                                required autofocus>
                            @if ($errors->has('email'))
                        ...
                        <div class="d-grid mx-auto">
                            <button type="submit"
                                class="btn btn-block p-3 mb-2 bg-primary bg-gradient text-white mb-4">SignIn</button>
                        </div>
                    </form>
                </div>
            </div>
